# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 05:41:08 2022
...
loandata['fico.category'] = ficocat        
 ...
 #for interest rates, a new column is wanter. cate > 0.12 then high, else low
 
loandata.loc[loandata['int.rate'] > 0.12, 'in.rate.type'] = 'High'
loandata.loc[loandata['int.rate'] <= 0.12, 'in.rate.type'] = 'Low'
